    ...
    <div className="space-y-24">
      ...
      >
        <div className="bg-black/60 p-8 rounded">
          ...
          <Link
            href="/vehicules"
            className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded text-sm uppercase tracking-wider"
          >
            Voir les véhicules
          </Link>
        </div>
      ...
      <section className="text-center px-6">
        ...
        <section className="w-full max-w-4xl mx-auto px-4 py-8">
          <div className="mb-4 text-center">
            <h2 className="text-2xl font-semibold text-gray-800">Garage Villebon Auto</h2>
            <p className="text-gray-600">9 Avenue de Norvège, 91140 Villebon-sur-Yvette, France</p>
          </div>
